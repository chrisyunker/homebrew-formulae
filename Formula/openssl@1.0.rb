# Taken from: https://raw.githubusercontent.com/Homebrew/homebrew-core/8b9d6d688f483a0f33fcfc93d433de501b9c3513/Formula/openssl.rb
# This will install openssl version 1.0.2t
...
class OpensslAT10 < Formula
  ...
  test do
    ...
    assert_predicate HOMEBREW_PREFIX/"#{openssldir}/openssl.cnf", :exist?,
